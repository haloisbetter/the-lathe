"""
OpenWebUI tool wrapper for The Lathe.

This module orchestrates calls to existing subsystems:
- lathe-prompts for system prompts
- lathe-context for context assembly
- lathe-validation for output validation

It contains no business logic, only orchestration.
"""
